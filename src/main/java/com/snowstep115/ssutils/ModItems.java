...
public class ModItems {
    public static final Item ANDESITE_COMPRESSED = new AndesiteCompressed();
    public static final Item COBBLESTONE_COMPRESSED = new CobblestoneCompressed();
    public static final Item DIORITE_COMPRESSED = new DioriteCompressed();
